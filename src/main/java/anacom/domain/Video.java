...
public class Video extends Video_Base {
	 ...
	 */
    public Video(int duration, int cost, String otherParty) 
    ...
    /**
     * get Communication Type of Class Video
     * @return the SMS string representation
     */
    @Override
    public String getCommunicationType() {
    	return CommunicationRepresentation.getInstance().getVideoCommunication(); 
    }
