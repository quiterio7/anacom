package cacert.application.handlers;
...
import cacert.application.SecurityInfo;
...
public class SecurityHandler implements SOAPHandler<SOAPMessageContext> {
	...
	public SecurityHandler() {
		...
		System.out.println("CACERT: Created Security Handler");
	}
	...
	public void close(MessageContext context) {
		System.out.println("CACERT: Handle Close");
	...
	public boolean handleFault(SOAPMessageContext context) {
		System.out.println("CACERT: Handle Fault");
	...
	public boolean handleMessage(SOAPMessageContext context) {
		System.out.println("CACERT: Handle Message");
	...
	private boolean handleOutboundMessage(SOAPMessageContext context) {
		System.out.println("CACERT: Handle Outbound Message");
	...
	private boolean handleInboundMessage(SOAPMessageContext context) {
		...
		try {
			if (isSignCertificateMessage(context)) {
				System.out.println("CACERT: Received SignCertificate Request:"
						+ " skipping validation");
				return true;
			} else {
	 ...
	 *             if the message does not have the expected structure
	 */
	private boolean isSignCertificateMessage(SOAPMessageContext context)
			throws SOAPException {
	...
	private boolean verifyCertificateSignature(CertificateType certificate)
		...
		System.out.println("CACERT: " + "CA signature is "
	...
	private boolean verifyTimePeriod(long validFrom, long validTo) {
		...
		System.out.println("CACERT: " + "Time validity is "
				+ (answer ? "correct" : "incorrect"));
	...
	private boolean verifyMessageSignature(SOAPMessageContext message,
		...
		System.out.println("CACERT: " + "Message signature is "
				+ (answer ? "correct" : "incorrect"));
		return answer;
	}
	...
	private boolean verifyBlackList(long serial) {
		...
		System.out.println("CACERT: " + "Black List validity is "
				+ (answer ? "correct" : "incorrect"));
		return answer;
	}
